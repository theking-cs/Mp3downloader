#!/bin/sh
# Instalador oficial para Mp3downloader - theking-cs
...
# El script busca el __init__.py que vimos en tu captura para localizar los archivos
...
# Reinicio de la interfaz en segundo plano para no colgar la consola
(echo "> Reiniciando interfaz gráfica..."; init 4 && sleep 3 && init 3) &
